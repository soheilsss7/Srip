...
grep -q "this.lifecycle.softDelete" "$root/apps/api/src/organizations/organizations.service.ts"
grep -q "this.lifecycle.softDelete" "$root/apps/api/src/people/people.service.ts"
grep -q "this.lifecycle.softDelete" "$root/apps/api/src/relationships/relationships.service.ts"
...
grep -q "relationshipScoreSnapshot" "$root/apps/api/src/intelligence/intelligence.service.ts"
