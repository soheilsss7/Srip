...
/* ------------------------------------------------------------------ */
/*  تأییدها — درخواست‌های تأیید دونفره با اثر واقعی پس از تأیید       */
  ...
  return (
    <main className="feature-page">
      <PageHeader
        eyebrow="تأییدها"
        title="تأییدها"
        description="تصمیم‌گیری دونفره برای عملیات حساس: تغییر امتیاز راهبردی، ایجاد رابطهٔ حساس، خروجی/اشتراک/ورود داده و حذف دائمی — تأیید اثر واقعی دارد و در ممیزی ثبت می‌شود."
        actions={
          <>
