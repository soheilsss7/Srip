...
export default function ExportPage() {
  ...
  return (
    <main className="feature-page">
      ...
      <p className="muted">
        گردش کار: ۱) «دریافت فایل» → درخواست تأیید خروجی ثبت می‌شود · ۲) مالک از صفحهٔ «تأییدها» تصمیم می‌گیرد · ۳) دوباره «دریافت فایل» → فایل صادر و در لاگ خروجی داده ثبت می‌شود.
      </p>
    </main>
  );
}
