...
const SECTIONS = [
  ...
  },
  {
    ...
    body: 'هاب «عموم‌ها» نقشهٔ ارتباط سازمان با ذی‌نفعان اثرگذار است. «شناسنامهٔ سازمان» — نوع شرکت، مأموریت، مالکیت و شرکت‌های تابعه — در پروفایل خودِ سازمان تعیین می‌شود و الگوی شش‌دسته‌ای (داخلی، نهادی و حاکمیتی، علمی و پژوهشی، اقتصادی و سرمایه‌گذاری، رسانه‌ای و عمومی، اکوسیستم فناوری و صنعت) مبنای نقشه است. در «گروه‌ها» همین فهرست ویژهٔ سازمان شما می‌شود. «اعضا و ارزیابی» هر عموم را با پیوند، مرحلهٔ بلوغ، موضع و قدرت و علاقه ثبت می‌کند و «ماتریس نفوذ×حمایت» جایگاه هر بازیگر را با درگ قابل اصلاح می‌کند. «پوشش (هیت‌مپ)» وضعیت پوشش هر دسته و منابع را یک‌جا نشان می‌دهد و «شکاف‌ها و اقدام» شکاف‌های بحرانی را با مسیر پیشنهادی و خلاصهٔ مدیریتی ارائه می‌کند. خروجی‌ها در «خروجی و رسانه»: JSON، CSV و Excel. گره‌های گراف «شبکهٔ روابط» با رنگ دسته و حلقهٔ طلایی «خودِ شرکت» برچسب می‌خورند و با فیلتر دسته قابل تفکیک‌اند.',
  },
  {
