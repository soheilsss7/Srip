...
export const STATUS_FA: Record<string, string> = {  ACTIVE:'فعال',
  ...
  PARTNER:'شریک راهبردی',
  COMPETITOR:'رقیب',
  INVESTOR:'سرمایه‌گذار',
  REGULATOR:'ناظر',
  GOVERNMENT:'نهاد دولتی و تنظیم‌گر',
  MEDIA:'رسانه',
  NGO:'سازمان مردم‌نهاد',
  ACADEMIC:'دانشگاه و پژوهش',
  ASSOCIATION:'اتاق و انجمن صنفی',
  ECOSYSTEM:'اکوسیستم فناوری و صنعت',
  MEETING:'جلسه',
  INTERACTION:'تعامل',
  COMMITMENT:'تعهد',
  EVENT:'رویداد',
...
export const REL_TYPE_FA: Record<string, string> = {
  ...
  MISSING_ENTRY:'بدون ورودی', CADENCE_BREAK:'آهنگ ارتباط از دست رفته',
