...
const expected=['organizations','people','relationships','interactions','meetings','actions','commitments','projects','opportunities','requirements','network','search','notifications','workflows','reports','data-management','data-quality','documents','admin','authorization','approvals','integrations','privacy','security','sessions','health','monitoring','analytics','metrics','observability'];
