...
export default function Search(){
  ...
  async function runSaved(id:string){setBusy('run'+id);try{setError('');const r:any=await api(`/search/saved/${id}/run`,{method:'POST'});setQ(r?.query??'');setData(r);await loadSaved();}catch(e){setError(e instanceof Error?e.message:String(e))}finally{setBusy('')}}
