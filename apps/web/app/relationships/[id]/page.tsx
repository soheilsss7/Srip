...
export default function Page({params}:{params:Promise<{id:string}>}){
 ...
 return <main className="feature-page">
  ...
  {!r&&!error?<Loading/>:r&&<>
   ...
   <QuickCreate open={quickOpen} onClose={()=>setQuickOpen(false)} onCreated={load} context={{relationshipId:id, organizationId:r.sourceOrganizationId}} />
  </>}
 </main>;
}