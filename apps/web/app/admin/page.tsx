...
export default function Admin(){
 ...
 const cards=[['users','کاربران'],['organizations','سازمان‌ها'],['roles','نقش‌ها'],['permissions','مجوزها'],['tags','Tagها'],['customFields','Custom Fields'],['workflows','Workflowها'],['integrations','Integrationها'],['audit','Audit']];
