...
{key:'person',label:'شخص',endpoint:'/people',fields:[{name:'firstName',label:'نام',required:true},{name:'lastName',label:'نام خانوادگی',required:true},{name:'organizationId',label:'شناسه سازمان',required:true},{name:'email',label:'ایمیل',type:'email'}]},
  {key:'relationship',label:'ارتباط',endpoint:'/relationships',fields:[{name:'sourceOrganizationId',label:'شناسه سازمان مبدأ',required:true},{name:'targetOrganizationId',label:'شناسه سازمان مقصد',required:true},{name:'relationshipType',label:'نوع ارتباط',required:true}]},
