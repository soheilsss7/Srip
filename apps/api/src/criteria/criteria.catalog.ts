 ...
 *  - Freeman (1977); Burt (1992, 2004); Granovetter (1973): network position →
...
export const SCALES: Record<ScaleId, { label: string; anchors: ScaleAnchor[] }> = {
  ...
  FINANCIAL_ZONE: {
    ...
    anchors: [
      { level: 0, label: 'ناحیهٔ خطر (Z″ < ۱٫۱ یا عدم شفافیت مالی)', score: 0 },
      { level: 1, label: 'منطقهٔ خاکستری (۱٫۱ تا ۲٫۶)', score: 40 },
      { level: 2, label: 'قابل قبول، حاشیهٔ کم', score: 60 },
      { level: 3, label: 'سالم (Z″ > ۲٫۶، نقدینگی کافی)', score: 85 },
...
export const FAMILY_META: Record<CriterionFamily, { name: string; nameEn: string; rationale: string }> = {
  STRATEGIC: {
    ...
    rationale:
      'معیارهای انتخاب شریک (Rickards 1986؛ Gulati 1995) و برجستگی ذی‌نفعان (Mitchell 1997؛ Mendelow 1991): قدرت، مشروعیت، فوریت و تناسب راهبردی.',
  },
  VALUE: {
    name: 'ارزش اقتصادی',
    nameEn: 'Economic value',
    rationale:
      'ارزش فعلی و چرخهٔ عمر رابطه (E&Y/Moody 2002) و معیار هزینه/سود در ادبیات انتخاب تأمین‌کننده (Dickson 1966).',
  },
  CAPABILITY: {
    name: 'توانمندی عملیاتی',
    nameEn: 'Operational capability',
    rationale:
      'معیارهای کلاسیک انتخاب تأمین‌کننده: کیفیت، تحویل به‌موقع، ظرفیت، توانمندی فنی، خدمات پس از فروش (Dickson 1966؛ Weber 1996).',
  },
  RELIABILITY: {
    name: 'قابلیت اتکا و رفتار رابطه‌ای',
    nameEn: 'Reliability & relational behaviour',
    rationale:
      'اعتماد و تعهد (Morgan & Hunt 1994) و ریشه‌های شکست رابطه: فرصت‌طلبی، بی‌وفایی در تعهد، ناتوانی در مدیریت اختلاف (Anderson & Narasimhan 1996؛ Choi & Lee 2007).',
  },
  ACCESS: {
    name: 'دسترسی و نفوذ در تصمیم',
    nameEn: 'Access & decision influence',
    rationale:
      'پوشش چندلایهٔ سازمان مشتری (Fortna et al. 2012؛ Gartner 2021) و قدرت/دسترسی/انگیزهٔ چمپیون (MEDDPICC).',
  },
  FINANCIAL: {
    name: 'سلامت مالی',
    nameEn: 'Financial health',
    rationale:
      'مدل Z امتن (1968، 2000)، نسبت‌های نقدینگی/اهرم/پوشش (CFA 2007) و چارچوب ریسک اعتباری بازل (PD/LGD/EAD).',
  },
  RISK: {
    name: 'ریسک، انطباق و حاکمیت',
    nameEn: 'Risk, compliance & governance',
    rationale:
      'ارزیابی ریسک طرف حساب: شفافیت مالکیت نهایی، غربالگری تحریم/PEP، رسانهٔ منفی، امنیت داده، ESG و تمرکز وابستگی (رویۀ due diligence شخص ثالث).',
  },
  NETWORK: {
    name: 'جایگاه در شبکه',
    nameEn: 'Network position',
    rationale:
      'بینانی/مرکزی Freeman (1977)، سوراخ‌های ساختاری Burt (1992، 2004) و پیوندهای ضعیف Granovetter (1973).',
  },
};
...
export const CRITERIA: Criterion[] = [
  /* ------------------------------- STRATEGIC ------------------------------- */
  {
    ...
    sources: ['Mitchell/Agle/Wood 1997 (Academy of Management Review)', 'Mendelow 1991 (ECIS)'],
  },
  {
    code: 'STRAT_FIT',
    family: 'STRATEGIC',
    ...
    sources: ['Gulati 1995 (Strategic Management Journal)', 'Das & Teng 1998 (AMR)'],
  },
  {
    ...
    sources: ['Dickson 1966', 'معیارهای ریسک‌تیئر ثالث (2026): replaceability within 30/60 days'],
  },
  {
    ...
    sources: ['Gainsight/Planhat renewal-risk drivers', 'ChurnZero executive alignment'],
  },
  /* --------------------------------- VALUE --------------------------------- */
  {
    code: 'VALUE_REALISED',
    ...
    sources: ['E&Y/Moody’s 2002 (Customer Lifetime Value)', 'Vitally: expansion & revenue signals'],
  },
  {
    code: 'VALUE_PIPELINE',
    family: 'VALUE',
    ...
    sources: ['Fortna et al. 2012 (high-velocity sales: pipeline quality)'],
  },
  {
    code: 'VALUE_MARGIN',
    family: 'VALUE',
    ...
    sources: ['Dickson 1966 (cost, terms)', 'Weber 1996 (profitability)'],
  },
  {
    code: 'VALUE_GROWTH',
    family: 'VALUE',
    ...
    sources: ['E&Y/Moody’s 2002 (CLV)', 'Custify: expansion opportunities'],
  },
  {
    code: 'VALUE_PAYMENT',
    family: 'VALUE',
    ...
    sources: ['Altman 2000 (default history)', 'CFA 2007 (counterparty payment behaviour)'],
  },
  /* ------------------------------- CAPABILITY ------------------------------ */
  {
    ...
    sources: ['Dickson 1966', 'Weber 1996 (quality system, technical capability)'],
  },
  {
    code: 'CAP_DELIVERY',
    family: 'CAPABILITY',
    ...
    sources: ['Dickson 1966 (delivery)', 'Custify: missed milestones as churn risk'],
  },
  {
    code: 'CAP_CAPACITY',
    family: 'CAPABILITY',
    ...
    sources: ['Weber 1996 (capacity, flexibility)', 'Gulati 1995 (complementary resources)'],
  },
  {
    code: 'CAP_TECH',
    family: 'CAPABILITY',
    ...
    sources: ['Dickson 1966 (technical capability)', 'Gulati 1998 (capability-based alliances)'],
  },
  {
    code: 'CAP_SERVICE',
    family: 'CAPABILITY',
    ...
    sources: ['Dickson 1966 (warranty & service)', 'Custify: support experience (tickets per user)'],
  },
  /* ------------------------------ RELIABILITY ------------------------------ */
  {
    code: 'REL_TRUST',
    ...
    sources: ['Morgan & Hunt 1994 (trust)', 'Li et al. 2026 (trust → commitment)'],
  },
  {
    code: 'REL_COMMITMENT',
    family: 'RELIABILITY',
    ...
    sources: ['Morgan & Hunt 1994 (commitment)', 'Jones et al. 1997 (commitment–trust theory)'],
  },
  {
    ...
    sources: ['Anderson & Narasimhan 1996 (root causes of failure)', 'Choi & Lee 2007 (opportunism)'],
  },
  {
    ...
    sources: ['Anderson & Narasimhan 1996', 'معیار due diligence: «answers must be verifiable, not narrative»'],
  },
  {
    code: 'REL_CONFLICT',
    family: 'RELIABILITY',
    ...
    sources: ['Rusbult et al. 1998 (exit–voice–loyalty–neglect)', 'Choi & Lee 2007'],
  },
  {
    ...
    sources: ['Anderson & Narasimhan 1996 (non-adapted behaviour)', 'Weber 1996 (flexibility)'],
  },
  /* --------------------------------- ACCESS -------------------------------- */
  {
  ...
  },
  {
    ...
    sources: ['MEDDPICC (EB access)', 'Custify: no executive engagement = renewal risk'],
  },
  {
    ...
    sources: ['MEDDPICC (Champion)', 'Fortna et al. 2012 (champion with measurable impact)'],
  },
  {
    ...
    anchors: [
      ...
      { level: 1, label: 'کاربر نهایی (UB) — اثر توصیه', score: 50 },
      { level: 2, label: 'تأییدکنندهٔ فنی/مالی (TB)', score: 70 },
      { level: 3, label: 'معرف و جهت‌دهنده (Coach/Champion)', score: 85 },
      { level: 4, label: 'تصمیم‌گیر نهایی (EB) با حق امضا', score: 100 },
    ],
    halfLifeDays: 365,
    intake: { prompt: 'نقش واقعی این فرد در تصمیم خرید/انتخاب چیست؟', help: 'اگر مطمئن نیستید، «کاربر نهایی» را انتخاب نکنید — خالی بگذارید.' },
    sources: ['میلرهایم هاين (Miller Heiman) Strategic Selling — EB/TB/UB/Coach', 'Mitchell 1997 (power dimension)'],
  },
  {
    ...
    sources: ['Custify/Cohere: responsiveness and communication cadence'],
  },
  {
    ...
    sources: ['Gainsight/ChurnZero: champion departure is a top renewal-risk driver', 'Custify: changing points of contact'],
  },
  /* -------------------------------- FINANCIAL ------------------------------ */
  {
    code: 'FIN_Z_SCORE',
    ...
    sources: ['Altman 1968, 2000 (Z-score)', 'Basel IRB (PD)'],
  },
  {
    code: 'FIN_LIQUIDITY',
    family: 'FINANCIAL',
    ...
    sources: ['CFA Investment Analysis Support & Portfolio Management 2007 (Ch. 5)'],
  },
  {
    code: 'FIN_LEVERAGE',
    family: 'FINANCIAL',
    ...
    halfLifeDays: 365,
    intake: { prompt: 'بار بدهی‌شان نسبت به سود چقدر است؟', help: 'تخمین «بدهی ÷ سود operate» هم کافی است.' },
    sources: ['CFA 2007 (leverage, coverage, liquidity)', 'Altman 2000'],
  },
  {
    code: 'FIN_COUNTRY',
    family: 'FINANCIAL',
    ...
    sources: ['Damodaran country-risk (CDS spread based)', 'Altman Hot’fi 2005 (country-risk rating)'],
  },
  /* ---------------------------------- RISK --------------------------------- */
  {
    ...
    sources: ['OFAC/UN/EU consolidated lists (عملکرد ارزیابی شخص ثالث)', 'AML/CFT onboarding practice'],
  },
  {
    code: 'RISK_UBO',
    family: 'RISK',
    ...
    anchors: [
      ...
      { level: 4, label: 'UBO تا شخص حقیقی نهایی شفاف و مستند', score: 0 },
    ],
    halfLifeDays: 540,
    intake: { prompt: 'مالک نهایی و ساختار سهام‌داری‌شان شفاف و مستند است؟', help: 'افشای ذی‌نفع واقعی؛ «نمی‌دانم» هم اطلاعات می‌دهد.' },
    sources: ['FinCEN CDD beneficial-ownership rule', 'عملکرد DDQ شخص ثالث (UBO verification)'],
  },
  {
    code: 'RISK_LEGAL',
    family: 'RISK',
    ...
    sources: ['vendor due diligence: legal & regulatory compliance domain'],
  },
  {
    ...
    anchors: [
      ...
      { level: 3, label: 'SOC 2/ISO 27001 معتبر', score: 20 },
      { level: 4, label: 'گواهی + تست نفوذ اخیر + قرارداد DPA', score: 0 },
    ],
    halfLifeDays: 365,
    intake: { prompt: 'برای داده و امنیت ما چه مدرکی دارند؟', help: 'ISO 27001، SOC 2، قرارداد محرمانگی، گزارش تست نفوذ.' },
    sources: ['Weber 1996 (privacy/data)', 'ISO/IEC 27001', 'عملکرد tiering بر اساس داده‌ای که مخاطب لمس می‌کند'],
  },
  {
    code: 'RISK_ESG',
    family: 'RISK',
    ...
    scaleId: 'MATURITY',
    halfLifeDays: 540,
    intake: { prompt: 'گزارش یا گواهی ESG/مسئولیت اجتماعی دارند؟', help: 'ISO 14001، ISO 45001، SA8000، گزارش پایداری، یا خط مشی ضدفساد.' },
    sources: ['ISO 14001/45001/SA8000', 'UNGP/OECD due-diligence guidance'],
  },
  {
    ...
    sources: ['Basel concentration risk', 'Porter 1980 (bargaining power)'],
  },
  {
    ...
    sources: ['AML/KYC PEP & related-party screening'],
  },
  /* --------------------------------- NETWORK ------------------------------- */
  {
    ...
    sources: ['Burt 1992 (secondary/indirect access to structural holes)'],
  },
  {
    code: 'NET_BRIDGE',
    family: 'NETWORK',
    ...
    sources: ['Burt 2004 (AJS: structural holes and good ideas)', 'Freeman 1977 (betweenness)', 'Valente & Fujimoto 2010 / Everett & Borgatti 2016 (brokerage)'],
  },
  {
    ...
    sources: ['Burt 1992 (network constraint)', 'Granovetter 1973'],
  },
  {
    ...
    sources: ['Granovetter 1973 (time spent + intensity + reciprocity)', 'Newman 2003 (tie strength)'],
  },
  {
    ...
    sources: ['Burt 1992 (shuttle diplomacy / third-party dependency)', 'Bottleneck & cut-vertex analysis'],
  },
  /* ---------------------- OPPORTUNITY-specific (sales) --------------------- */
  {
    ...
    sources: ['Gartner 2021 (6–10 stakeholders)', 'MEDDPICC (Paper Process)'],
  },
  {
    ...
    sources: ['MEDDPICC (Paper Process)', 'Dickson 1966 (contract terms)'],
  },
  {
    ...
    sources: ['MEDDIC (Metrics)', 'Fortna et al. 2012 (identified pain)'],
  },
  {
    ...
    sources: ['Gainsight: activity→activity & activity→pipeline conversion'],
  },
  {
    code: 'OPP_ADVOCACY',
    family: 'RELIABILITY',
    ...
    sources: ['Gainsight: sentiment > NPS', 'MEDDPICC (Champion)'],
  },
];
