...
export const PERMISSIONS = [
  ...
  'search.read','search.write','analytics.read','ai.executive_brief','ai.read','ai.query','analytics.write','network.read','security.read','metrics.read','integration.read','integration.write','recommendation.read','recommendation.write',
  ...
  'access.manage','role.manage','admin.users','admin.organizations','admin.catalog','admin.custom_fields','admin.scoring_rules','admin.notification_rules','admin.ai_settings','admin.integrations','admin.audit','scoring.admin','data.import','data.import.approve','data.quality.read','data.quality.execute','approval.request','approval.read','approval.decide','privacy.read','privacy.export','privacy.access','privacy.erase','privacy.manage','privacy.audit','session.admin.revoke',
] as const;
