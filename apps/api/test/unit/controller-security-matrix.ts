 ...
 */
export const CONTROLLER_SECURITY_MATRIX: Record<
  string,
  ControllerSecurityRule
> = {
  ...
  "auth.controller.ts": {
    category: "PUBLIC",
    exceptions: ["POST auth/email/resend requires AuthGuard"],
  },
  "authorization-admin.controller.ts": {
    category: "AUTHORIZED",
    requiredGuards: ["AuthGuard", "AuthorizationGuard"],
    requirePermission: true,
  },
  ...
  "integration-webhook.controller.ts": {
    category: "WEBHOOK_SIGNED",
    requiredGuards: ["WebhookSignatureGuard"],
  },
  ...
  "metrics.controller.ts": {
    category: "INTERNAL",
    requiredGuards: ["InternalMetricsGuard"],
  },
  ...
  "notification-alerts.controller.ts": {
    category: "AUTHENTICATED",
    requiredGuards: ["AuthGuard"],
  },
  ...
  "relationship-score.controller.ts": {
    category: "AUTHORIZED",
    requiredGuards: ["AuthGuard", "AuthorizationGuard"],
    requirePermission: true,
  },
