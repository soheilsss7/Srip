...
async function main() {
  const permissions = [
    ...
    'workflow.write', 'workflow.execute', 'integration.read', 'integration.write', 'search.read', 'search.write', 'analytics.read', 'analytics.write', 'ai.executive_brief', 'ai.read', 'ai.query', 'network.read', 'recommendation.read', 'recommendation.write', 'data.restore', 'data.permanent_delete', 'data.lifecycle_status',
  ...
  const rolePermissions: Record<string,string[]> = {
    ...
    HOLDING_EXECUTIVE: ['metrics.read','approval.request','approval.read','approval.decide','org.read','entity.read','tag.read','person.read','relationship.read','relationship.strategic.read','relationship.risk.read','interaction.read','meeting.read','action.read','commitment.read','project.read','opportunity.read','audit.read','security.read','workflow.read','report.read','workflow.execute','search.read','search.write','analytics.read','analytics.write','ai.executive_brief', 'ai.read', 'ai.query','network.read','recommendation.read','recommendation.write','integration.read','integration.write'],
    SUBSIDIARY_ADMIN: permissions.filter(x => !['access.manage','role.manage','data.permanent_delete'].includes(x)),
    SUBSIDIARY_EXECUTIVE: ['metrics.read','approval.request','approval.read','approval.decide','org.read','entity.read','tag.read','person.read','relationship.read','relationship.strategic.read','relationship.risk.read','interaction.read','meeting.read','action.read','commitment.read','project.read','opportunity.read','workflow.read','search.read','search.write','analytics.read','analytics.write','ai.executive_brief', 'ai.read', 'ai.query','network.read','report.read','data.quality.read','data.lifecycle_status'],
