...
async function main() {
  const permissions = [
    ...
    'workflow.write', 'workflow.execute', 'integration.read', 'integration.write', 'search.read', 'analytics.read', 'analytics.write', 'ai.executive_brief', 'ai.read', 'ai.query', 'network.read', 'recommendation.read', 'recommendation.write', 'data.restore', 'data.permanent_delete',
  ...
  const rolePermissions: Record<string,string[]> = {
    ...
    STANDARD_USER: ['approval.request','approval.read','report.read','org.read','entity.read','tag.read','person.read','relationship.read','interaction.read','meeting.read','action.read','commitment.read','project.read','search.read','analytics.read','ai.executive_brief', 'ai.read', 'ai.query','recommendation.read','integration.read'],
    READ_ONLY: ['approval.request','approval.read','report.read','org.read','entity.read','tag.read','person.read','relationship.read','interaction.read','meeting.read','action.read','commitment.read','project.read','opportunity.read','search.read','analytics.read','ai.executive_brief', 'ai.read', 'ai.query','recommendation.read','integration.read'],
  };
  const roles = [
